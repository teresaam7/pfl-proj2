...
1. **Evaluation Function:** The algorithm uses evaluateBoard/2 to assign scores to board states. Higher scores favor configurations that:
...
3. **Move Selection:**
   ...
   - The bot iterates through all valid moves (generated by validMoves/2) and simulates the board state after each move.
